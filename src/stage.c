...
static void drawHud(void)
{
    ...
    {
        drawText(SCREEN_WIDTH - 10, 10, 0, 255, 0, 
            TEXT_RIGHT, "HIGHSCORE: %03d", highscores.highscore[0].score);
    }
    else
    {
        drawText(SCREEN_WIDTH - 10, 10, 255, 255, 255, 
            TEXT_RIGHT, "HIGHSCORE: %03d", stage.score);
    }
}
